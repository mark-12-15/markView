...
void BCCommon::SetApplicationSkin(const QString &qsStyle)
{
    ...
    BCRibbonMainToolBar *pMainToolBar = m_pApplication->GetRibbonMainToolBar();
    if (NULL != pMainToolBar) {
        pMainToolBar->RefreshIcon();
    }
...
bool BCCommon::g_bConnectStatusOK = true;
bool BCCommon::g_bConnectWithServer = false;
bool BCCommon::g_bEchoModel = true;
...
int BCCommon::g_nPreviewTick = 1234;
int BCCommon::g_nPreviewDirectDevice = 1;
...
// 工程属性设置
QString BCCommon::g_qsApplicationVersion = "V3.11.55";
QString BCCommon::g_qsApplicationTitle = QObject::tr("控制平台");
QString BCCommon::g_qsApplicationCompany = QObject::tr("博睿科技");
...
QString BCCommon::g_qsTrayIconTooltips = QObject::tr("display platform");            // 托盘默认提示内容
